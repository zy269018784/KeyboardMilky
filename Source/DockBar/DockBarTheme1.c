...
void CreateDockBarTheme1(DockBar *Bar, lv_obj_t *Parent)
{
    ...
    lv_obj_set_style_bg_color(Bar->ButtonHomePage, App->CurrentTheme.main_color, 0);
    ...
    lv_obj_set_style_bg_color(Bar->ButtonMusic, App->CurrentTheme.sub_color, 0);
    ...
    lv_obj_set_style_bg_color(Bar->ButtonClock, App->CurrentTheme.sub_color, 0);
    ...
    lv_obj_set_style_bg_color(Bar->ButtonSystemInfo, App->CurrentTheme.sub_color, 0);
    ...
    lv_obj_set_style_bg_color(Bar->ButtonSetting, App->CurrentTheme.sub_color, 0);
