...
void CreateTheme1ClockPage(ClockPage* Page, lv_obj_t* Parent, Theme* Theme)
{
    ...
    /*
        开始按钮
    */
    Page->start_button = CreateButton(Page->Handle, 
        Theme->timer_start_button_postion.x, 
        Theme->timer_start_button_postion.y, 
        Theme->timer_start_button_size.x,
        Theme->timer_start_button_size.y,
        lv_color_hex3(0xF0F));
    ...
    /*
        结束按钮
    */
    Page->stop_button = CreateButton(Page->Handle, 
        Theme->timer_stop_button_postion.x,
        Theme->timer_stop_button_postion.y,
    ...
    */
    ...
    CreateTheme1ClockPageTimeUp(Page, Parent, Theme);
}
